...
class DiscussionThreadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discussion_thread" do
    assert_difference("DiscussionThread.count") do
      post discussion_threads_url, params: { discussion_thread: { board_id: @discussion_thread.board_id, content: @discussion_thread.content, title: @discussion_thread.title } }
    end
  ...
  test "should update discussion_thread" do
    patch discussion_thread_url(@discussion_thread), params: { discussion_thread: { board_id: @discussion_thread.board_id, content: @discussion_thread.content, title: @discussion_thread.title } }
